...
object OkhttpUtils {
    ...
    private val executorService = ThreadPoolExecutor(
        ...
        SynchronousQueue(), threadFactory("OkHttpClient Dispatcher", true)
    )
    ...
    private val noRetryShortOkHttpClient = OkHttpClient.Builder()
    ...
    private val noRetryOkHttpClient = OkHttpClient.Builder()
        .connectTimeout(60L, TimeUnit.SECONDS)
        .readTimeout(30L, TimeUnit.MINUTES)
        .writeTimeout(30L, TimeUnit.MINUTES)
        .dispatcher(Dispatcher(executorService))
    ...
    fun downloadFile(url: String, destPath: File) {
        ...
        okHttpClient.newCall(request).execute().use { response ->
            ...
            logger.info("destPath: ${destPath.absolutePath}, file is Exist:${destPath.exists()}")
        }
    }
