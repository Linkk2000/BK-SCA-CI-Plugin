...
object KubernetesExecutor {
    ...
    fun exposeJob(createServiceReq: CreateServiceReq): DockerRunResponse {
        val task = KubernetesBuildApi().createService(createServiceReq).data
    ...
    private fun getJobRequest(param: DockerRunRequest): DispatchJobReq {
        with(param) {
            ...
            return DispatchJobReq(
                alias = "job-executor-${System.currentTimeMillis()}",
